...
def main():
    ...
    * Print total program running time.
    ...
    # Get the correct Parse class identifier for this event
    THIS_EVENT = 1 # will figure out how to accurately retrieve this later
    THIS_EVENT_CLASS_ID = get_event_class_name(THIS_EVENT)

    # Call (or comment out) all desired creation functions.
    ...
    !@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*\
    \n\n\
    Program \"main.py\" has finished running in {} seconds.\
    \n\n\
    !@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*!@#$%^&*\
    \n\
